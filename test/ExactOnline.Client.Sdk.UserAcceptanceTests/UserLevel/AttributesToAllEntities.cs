...
namespace ExactOnline.Client.Sdk.UserAcceptanceTests.UserLevel
{
	...
	public class AttributesToAllEntities
	{
		...
		public void ReadAllEntities()
		{
			...
			var mailMessageCollection = client.For<MailMessagesSent>().Select("ID").Get();
			...
			var outstandingInvoiceOverviewCollection = client.For<OutstandingInvoicesOverview>().Select("CurrencyCode").Get();
