Public Class [Services]
	...
	Public Sub New()
		...
		Services.Add(GetType(Bulk.SalesOrderLine).FullName, "Bulk/SalesOrder/SalesOrderLines")
		...
		Services.Add(GetType(Cashflow.ImportNotification).FullName, "Cashflow/ImportNotifications")
		Services.Add(GetType(Cashflow.ImportNotificationDetail).FullName, "Cashflow/ImportNotificationDetails")
		...
		Services.Add(GetType(CRM.HostingOpportunity).FullName, "CRM/HostingOpportunities")
		...
		Services.Add(GetType(Financial.OfficialReturn).FullName, "Financial/OfficialReturns")
		...
		Services.Add(GetType(Webhooks.WebhookSubscription).FullName, "Webhooks/WebhookSubscriptions")
